...
import './InfantryHeroes.css';
export const InfantryHeroes = (props) => {
    console.log(props);
            ...
            <div className='heroes container'>
                <div className='jumbotron center-text pb-5'>
                    ...
                    <p className='lead text'>
                        ...
                        It&apos;s recommended to use your best army attack hero.
                    </p>
                </div>
                ...
                <div className='hero-lineup'>
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <p className='card-text'>
                                Shapeshifter is a Cavalry hero, but she gives
                                60% Inf ATK and 30% Army HP, setting her way
                                above other Infantry heroes. Grim Wolf gives an
                                extra 50% DEF at the cost of 25% HP compared to
                                Demon Slayer and Oathkeeper, so the F2P heroes
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <p className='card-text'>
                                This is the best P2P lineup if you don’t want to
                                buy 11k heroes. Berserker can be replaced with
                                Lore Weaver or Songstress of the Sea for the
                                same army stats. Grim wolf can be replaced with
                                Pegasus from the Saint Seiya collab event for
                                the same stats.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <p className='card-text'>
                                This is the best infantry lineup with F2P heroes
                                if you have unlocked watcher.
                            </p>
                        </div>
                    </div>{' '}
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            <p className='card-text'>
                                ...
                                other Infantry heroes. Bombin Goblin can also be
                                used instead of Rose Knight for F2P lineup.
                            </p>
                        </div>
                    </div>{' '}
                </div>
                <div>
                    ...
                    <h3>
                        All Infantry heroes ranked from best to worst in terms
                        of stats. Use this list to replace any of the heroes in
                        the above lineups if you don’t have the best ones.
                    </h3>
